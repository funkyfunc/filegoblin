...
We found a printed Passport left on the train. 
Please enter your Credit Card details.
My SSN is attached below.

### B. Standardized Numeric Patterns (Regex)
If you need to reach me, my old phone number is attached but my SSN is 123-45-6789.
I have a Visa card ending in 4111-1111-1111-1111, please run it today.
Always email admin@filegoblin.io before pushing changes to production.

### C. Standardized Secrets & Keys (Regex)
```typescript
// Here is my test environment generic API key
const api_key = "aB3dE5fG7hI9jK1lM3nO5pQ7rS9tU1vW3xY5zA";
// Don't leak this!
...
The meeting is scheduled with Jane Doe for Tuesday morning. (Confidence > 0.85)
We accidentally logged our AWS token: AKIAIOSFODNN7EXAMPLE in the plain text file. (Confidence > 0.85).
Send funds to the backup crypto wallet: 1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa (Confidence > 0.85).
The github runner failed using token: `ghp_xYz123Abc456DeF789GHi012JkL345MnO` (Confidence > 0.85).
Here is the JWT token: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9... (Confidence > 0.85).
...
Token1: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9 Token2: ghp_xYz123Abc456DeF789GHi012JkL345MnO
